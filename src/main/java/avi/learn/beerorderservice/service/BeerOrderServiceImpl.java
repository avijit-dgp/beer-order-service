...
import avi.learn.beerorderservice.repository.BeerOrderRepository;
import avi.learn.beerorderservice.repository.CustomerRepository;
import avi.learn.beerorderservice.web.mappers.BeerOrderMapper;
...
public class BeerOrderServiceImpl implements BeerOrderService {
    ...
    public BeerOrderPagedList listOrders(UUID customerId, Pageable pageable) {
        ...
        if (customerOptional.isPresent()) {
            ...
            return new BeerOrderPagedList(beerOrderPage
                    .stream()
                    .map(beerOrderMapper::beerOrderDtoFromBeerOrder)
    ...
    public BeerOrderDto placeOrder(UUID customerId, BeerOrderDto beerOrderDto) {
        ...
        if (customerOptional.isPresent()) {
            BeerOrder beerOrder = beerOrderMapper.beerOrderFromBeerOrderDto(beerOrderDto);
            ...
            return beerOrderMapper.beerOrderDtoFromBeerOrder(savedBeerOrder);
        }
    ...
    public BeerOrderDto getOrderById(UUID customerId, UUID orderId) {
        return beerOrderMapper.beerOrderDtoFromBeerOrder(getOrder(customerId, orderId));
    }
